...
// So, we should have the template class in item.h and no item.cpp file.
...
class Item {
    private:
        ...
        T value;
    public:
        Item(std::string name, const T value) : name{name}, value{value} {
...
int main() {
    ...
    MyPair <int, double> p2 {100, 200.6};
