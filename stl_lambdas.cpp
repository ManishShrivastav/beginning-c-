...
// See cppreference.com for more information on STL algorithms and lambdas

// for_each - Non-modifying sequence operation
// Displays each element in nums
...
// Tests whether two triangles are equivalent. Triangles are 
// defined by a vector of three points in any order. Regardless of 
// the order of the points, if two triangles contain the same 
// three points, they are equivalent. This is determined by testing 
// whether sequence of points is a permutation of the other using
// predicate lambda function to compare the points.
...
void test2() {
    ...
    std::vector<Point> triangle2 { pt3, pt1, pt2 };
