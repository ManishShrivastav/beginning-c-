...
int main()
{
    ...
    cout << " letters long and the length of the last name, " << last_name << ", is " << last_name_length;
    cout << " letters long. This means that the length of the whole name must be " << whole_name_length << " letters long." << endl;
