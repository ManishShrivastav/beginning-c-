...
int main()
{
    ...
    cout << "What is the multiple you want to multiply? ";
    cin >> multiple;

    cout << "Enter a multiplier: ";
    cin >> multiplier;

    multiply_with_pointer(&multiple, multiplier);

    cout << "The result is " << multiple; // The value obtained from function is stored in variable "multiple"
    cout << endl;
